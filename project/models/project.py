...
class Project(models.Model):
    ...
    def _compute_requerimiento_count(self):
        requerimiento_data = self.env['project.requerimiento']
        for project in self:
            project.requerimiento_count = requerimiento_data.search_count([('project_id', '=', project.id)])            
    ...
    # Requerimiento:
    label_requerimientos = fields.Char(string='Usar requerimientos como', default=lambda s: _('Requerimientos'), translate=True,
        help="Gives label to requests on project's kanban view.")    
    ...
    # Requerimiento:
    requerimiento_count = fields.Integer(compute='_compute_requerimiento_count', string="Cantidad de Requerimientos")
    ...
    @api.multi
    def open_tasks(self):
        _('Esto es un mensaje de notificación')
